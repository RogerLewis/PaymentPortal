			...
			<!-- PRICE ITEM -->
    			<form action="<?php echo $paypalUrl; ?>" method="post" name="frmPayPal1">
					<div class="panel price panel-red">
						    ...
						    <input type="hidden" name="cancel_return" value="http://demo.EXAMPLE.com/paypal/cancel.php">
						    <input type="hidden" name="return" value="http://demo.EXAMPLE.com/paypal/success.php">  
